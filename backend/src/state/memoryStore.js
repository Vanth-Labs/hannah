...
// El historial completo de conversaciones: solo el usuario debería poder leerlo.
if (DB_PATH !== ':memory:') { try { fs.chmodSync(DB_PATH, 0o600); } catch { /* Windows / no existe aún */ } }
